    ...
    <div class="container">
        <div class="row">
            <form id="email-form" name="email-form" action="<?php the_permalink(get_page_by_path('resultat')); ?>" method="get" data-name="Email Form"><label for="Recherche" class="search-label"></label>
                <div class="row">
                    <div class="col-md-8 col-sm-9 col-9"><input type="text" class="form-field input w-input" maxlength="256" name="recherche" data-name="Recherche" placeholder="Rechercher" id="Recherche" required=""><span class="underline"></span></input>
                    </div>
