...
if (isset($_GET['recherche']) && $_GET['recherche'] != "") {
    ...
    $articles  = new WP_Query(array('post_type' => array('post', 'produit', 'page'), 's' => $recherche, 'orderby' => 'date', 'posts_per_page' => '1000'));
}
?>
            ...
            <div class="articles-list">
                <div class="article-list_2items">
                    ...
                    while ($articles->have_posts()) : $articles->the_post(); ?>
                        <?php if (get_post_type() == "post" || get_post_type() == "produit") : ?>
                                ...
                                <a href="<?php the_permalink(); ?>/" class="news-list_item-content <?php echo ($p == 0) ? 'left' : ''; ?> w-inline-block">
                                    <div class="slt">
                                        <div class="news-list_item-thumbnail">
                                            ...
                                            <?php if ($p == 1) : ?>
                                                <div class="deco2">
                                                    <img src="<?php bloginfo('template_directory'); ?>/assets/images/deco-article2.svg" loading="lazy" alt="">
                                                </div>
                                            <?php endif; ?>
                                        </div>
                                        <div class="news-list_item-summary">
                                            ...
                                            <div class="article-list_item-date">
                                                ...
                                                <?php elseif (get_post_type() == "produit") : ?>
                                                    <?php
                                                    $id_marque = get_field('marque_produit');
                                                    ?>
                                                    <p><?php echo get_the_title($id_marque[0]); ?></p>
                                                <?php endif; ?>
                                            </div>
